...
struct s_glow_object_definition {
	...
	int									glow_style;											//0x002C
	int									split_screen_slot;							//0x0030
	int									next_free_slot;									//0x0034

public:
	void color(float r, float g, float b, float a) {
		glow_color[0] = r / 255.f;
		glow_color[1] = g / 255.f;
		glow_color[2] = b / 255.f;
		glow_color[3] = a / 255.f;
	}
	void color(s_color_rgba color) {
		glow_color[0] = color.r / 255.f;
		glow_color[1] = color.g / 255.f;
		glow_color[2] = color.b / 255.f;
		glow_color[3] = color.a / 255.f;
	}
};